...
class Update extends UpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if ($global == false) {
            $templatesCount = $this->modx->getCount(CollectionTemplate::class, array('global_template' => 1, 'id:!=' => $this->object->id));
            if ($templatesCount == 0) {
        ...
        if (count($templates) > 0) {
            ...
            $c->where($where);
            $c->select($this->modx->getSelectColumns(modTemplate::class, 'ResourceTemplate', '', array('templatename')));
    ...
    public function afterSave()
    {
        ...
        if ($global == true) {
            $this->modx->updateCollection(CollectionTemplate::class, array('global_template' => false), array('id:!=' => $this->object->id));
        }
