...
class GetCollection extends Endpoint
{
    ...
    function process()
    {
        ...
        $parentObject = $this->modx->getObject(modResource::class, $collection);
        ...
        $c->leftJoin(modUserProfile::class, 'Profile', 'CreatedBy.id = Profile.internalKey');
        ...
        $c->select($this->modx->getSelectColumns(modUserProfile::class, 'Profile', '', ['fullname']));
