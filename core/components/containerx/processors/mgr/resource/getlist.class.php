 ...
 */
class ContainerXResourcerGetListProcessor extends modObjectGetListProcessor {
    ...
    public function prepareRow(xPDOObject $object) {
        ...
        if ($object->hasChildren() > 0 || $object->class_key == 'ContainerX') {
            return;
        }
...
return 'ContainerXResourcerGetListProcessor';