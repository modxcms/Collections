...
export default config => (fred, Plugin, pluginTools) => {
    ...
    return class SidebarPlugin extends Plugin {
        ...
        renderModal(collection, authors) {
                ...
                columns:[
                    ...
                    {title:"Author", field:"fullname", headerSort:false, width: 180},
                    {
                        ...
                        formatter: function(cell, formatterParams, onRendered){
                            ...
                            const edit = (data.deleted) ? '' : `<a href="${data.fullUrl}">E</a>`;
                            const publish = (data.published) ? '<button data-action=\'unpublish\'>UP</button>' : '<button data-action=\'publish\'>P</button>';
                            const deleteAction = (data.deleted) ? '<button data-action=\'undelete\'>UD</button>' : '<button data-action=\'delete\'>D</button>';
            ...
            const newPage = button('New Page', 'New Page', '', () => console.log('New Page'));
